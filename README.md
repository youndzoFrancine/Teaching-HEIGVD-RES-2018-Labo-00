...
* One possibility would be to install all tools directly on top of your operating system. You use your IDE, build the software, run the tests in your usual environment. 
...
* Note: the "lab box" is now deprecated. It was created when some of the tools that we will use later in the semester (e.g. docker) was creating issues on some operating systems. Because these issues have been resolved, it is now more practical to install the toolset directly on top of your OS.
...
```
$ cd Teaching-HEIGVD-RES-2018-Labo1/
$ ls
